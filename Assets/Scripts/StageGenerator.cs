...
public class StageGenerator : MonoBehaviour
{
    ...
    public List<GameObject> generatedStageList = new List<GameObject>(); //--- 5.생성된 스테이지의 팁의 보유 리스트

    void Start()
    {
        currentTipIndex = startTipIndex - 1; //--- 6.초기화 처리
        UpdateStage(preInstantiate); //--- 7.스테이지의 업데이트 타이밍 감시
    }
